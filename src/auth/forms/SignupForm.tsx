    ...
    return (
        <Form {...form}>
            <div className="sm:w-420 flex-center flex-col">
                ...
                <h2 className="h3-bold mb:h2-bold pt-5 sm:pt-12">Create a new account</h2>
                <p className="text-light-3 small-medium md:base-regular">To use MANA, please create your account</p>
